...
public class MyCP extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.wordbook";
...
//        db = LitePal.getDatabase();
    ...
    public String getType(@NonNull Uri uri) {
        switch (uriMatcher.match(uri)) {
            case WORD_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.wordbook";
            case WORD_ITEM:
                return "vnd.android.cursor.item/vnd.com.example.wordbook";
            default:
                break;
        }
        return null;
